...
namespace joint_effort_trajectory_controller
{
  ...
  const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> msg)
{
  ...
  // http://wiki.ros.org/joint_effort_trajectory_controller/UnderstandingTrajectoryReplacement
...
PLUGINLIB_EXPORT_CLASS(
  joint_effort_trajectory_controller::JointTrajectoryController, controller_interface::ControllerInterface)