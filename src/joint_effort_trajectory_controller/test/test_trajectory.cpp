...
using namespace joint_effort_trajectory_controller::interpolation_methods;  // NOLINT
...
TEST(TestTrajectory, initialize_trajectory)
{
  auto clock = rclcpp::Clock(RCL_STEADY_TIME);
  {
    ...
    auto traj = joint_effort_trajectory_controller::Trajectory(empty_msg);

    trajectory_msgs::msg::JointTrajectoryPoint expected_point;
    joint_effort_trajectory_controller::TrajectoryPointConstIter start, end;
...
TEST(TestTrajectory, sample_trajectory_positions)
{
  ...
  auto traj = joint_effort_trajectory_controller::Trajectory(time_now, point_before_msg, full_msg);
...
TEST(TestTrajectory, interpolation_pos_vel)
{
  ...
  auto traj = joint_effort_trajectory_controller::Trajectory();
