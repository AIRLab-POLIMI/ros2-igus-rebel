...
#include "joint_effort_trajectory_controller/joint_effort_trajectory_controller.hpp"
...
: public joint_effort_trajectory_controller::JointTrajectoryController
{
public:
  using joint_effort_trajectory_controller::JointTrajectoryController::JointTrajectoryController;
  using joint_effort_trajectory_controller::JointTrajectoryController::validate_trajectory_msg;

  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = joint_effort_trajectory_controller::JointTrajectoryController::on_configure(previous_state);
...
public:
  ...
  virtual void SetUp()
  {
    controller_name_ = "test_joint_effort_trajectory_controller";
